...
/**
 * Inlay hints provider for TypeScript code using Neoai AI suggestions.
 */
public class NeoaiLensTypescriptProvider implements InlayHintsProvider<NeoaiLensTypescriptProvider.NeoaiHint> {
    ...
    public String getName() {
        return "Neoai TypeScript Hints";
    }

    @Override
    public boolean isLanguageSupported(@NotNull Language language) {
        return language.isKindOf("TypeScript") || language.isKindOf("JavaScript");
    }
    ...
    private String generateFunctionHint(@NotNull PsiFunction function) {
        ...
        return "💡 Neoai: Consider adding JSDoc";
    }
