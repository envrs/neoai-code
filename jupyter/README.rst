...
Other client plugins of NeoAi require starting a child process for NeoAi binary
...
The server plugin pass the request info to it's client process (NeoAi) and return the request to client plugin.
...
::
    ...
    jupyter nbextension enable jupyter_neoai/jupyter_neoai
