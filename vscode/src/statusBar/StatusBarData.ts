...
export default class StatusBarData implements Disposable {
  ...
  public updateStatusBar() {
    ...
    if (shouldStatusBarBeProminent()) {
      this._statusBarItem.text = `${ATTRIBUTION_BRAND}Neoai: Sign-in is required`;
