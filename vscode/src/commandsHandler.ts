...
const CONFIG_EXTERNAL_COMMAND = "NeoAi::configExternal";
export const STATUS_BAR_COMMAND = "NeoAi.statusBar";
export const SIGN_IN_AUTH_TOKEN_COMMAND = "neoai.signInUsingAuthToken";
